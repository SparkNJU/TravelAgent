      ...
      <div class="content-area">
        ...
        <div v-if="activeTab === 'posts'" class="posts-section">
          ...
          <div v-else class="posts-grid">
            <article v-for="post in posts" :key="post.id" class="post-card" @click="openNote(post)">
            ...
            <div class="detail-content">
              ...
              <div class="detail-actions">
                ...
                <button
                  ...
                  @click="handleNoteLike(selectedNote)"
                >
...
function normalizePost(post) {
  ...
  return {
    ...
    city: tags[0] || '旅行',
    channel: 'all',
    cover: (post.images && post.images.length) ? post.images[0] : 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&w=900&q=80',
    tags,
...
async function handleNoteLike(note) {
